...
from model import GCNModelDoubleAttScatVAE, GCNModelVAE, GCNModelScatVAE, GCNModelAttScatVAE
from utils import preprocess_graph, make_ad_dataset, pred_anomaly, precision
from sklearn.metrics import roc_auc_score, f1_score
from optimizer import scat_ae_loss_function
from fms import FMS
...
def gae_ad(args):
    ...
    if torch.cuda.is_available() is True:
        ...
        for epoch in range(args.epochs):
            ...
            error, f_error, s_error, total_loss, feature_reconstruction_loss, structure_reconstruction_loss = scat_ae_loss_function(
