...
def load_ad_data(dataset_address):
    ...
    if isinstance(adj, np.ndarray) is True:
        ...
        #print("type(adj)",type(adj))
        #print(type(np.array(adj.todense())),np.array(adj.todense()))
        #print(type(nx.from_numpy_array(np.array(adj.todense()))),nx.from_numpy_array(np.array(adj.todense())))
...
#print("cora",adj[:10,:10])
#adj, features, gnd = load_ad_data('/Users/suyuhao/Desktop/anomaly detection/gae/data/Amazon.mat')
#data = sio.loadmat('/Users/suyuhao/Desktop/anomaly detection/gae/data/Amazon.mat')
#print("disney",adj[:10,:10])
